...
@ExtendWith(MockitoExtension.class) // P/ executar essa classe de teste unitário, uma extensão do Mockito será utilizada
public class BeerServiceTest {   // p/ criar os objetos dublês
    ...
    void whenBeerInformedThenItShouldBeCreated() throws BeerAlreadyRegisteredException {
        ...
        // when
        when(beerRepository.findByName(
                expectedBeerDTO.getName()))
        ...
        // id do BeerDTO criado e o mesmo id passado
    ...
    void whenAlreadyRegisteredBeerInformedThenAnExceptionShouldBeThrown() {
        ...
        // when
        when(beerRepository.findByName(expectedBeerDTO
                .getName()))
                .thenReturn(Optional.of(duplicatedBeer));

        // then testar se a exceção será lançada
    ...
    void whenValidBeerNameIsGivenThenReturnABeer() throws BeerNotFoundException {
        ...
        // when
        when(beerRepository.
                findByName(expectedFoundBeer.getName()))
                .thenReturn(Optional.of(expectedFoundBeer));

        // then
        BeerDTO foundBeerDTO = beerService
    ...
    void whenListBeerIsCalledThenReturnAnEmptyListOfBeers() {
        //when -> mockito para buscar uma lista vazia em Collections
        when(beerRepository.findAll())
    ...
    void whenExclusionIsCalledWithValidIdThenABeerShouldBeDeleted() throws BeerNotFoundException{
        ...
        // when || mockito p/ buscar o id de uma cerveja
        ...
        doNothing().when(beerRepository)
                .deleteById(expectedDeletedBeerDTO.getId()); // não faça nada, pq não retorna nada

        // then
        beerService.deleteById(expectedDeletedBeerDTO.getId());

        // verify 1 vez para buscar id
        verify(beerRepository, times(1))
                .findById(expectedDeletedBeerDTO
                        .getId());

        // verify 1 vez para bdeletar id
        verify(beerRepository, times(1))
                .deleteById(expectedDeletedBeerDTO
                        .getId());
    }
    ...
    void whenIncrementIsCalledThenIncrementBeerStock() throws BeerNotFoundException, BeerStockExceededException {
        ...
        //when
        when(beerRepository.findById(expectedBeerDTO
                .getId()))
        ...
        assertThat(expectedQuantityAfterIncrement, equalTo(incrementedBeerDTO
                .getQuantity()));
